export const translationExercises = {
  englishToArabic: [
    "Translate into Arabic: 'The area of agricultural land in the world decreases as a result of desertification.'",
    "Translate into Arabic: 'Reading literature shapes our minds and teaches us issues about the change in society.'",
    "Translate into Arabic: 'A civilized society should treat its elderly members well even if it is multicultural.'",
    "Translate into Arabic: 'One of the current reform programs is to stimulate investment in the industrial sector.'",
    "Translate into Arabic: 'Livelihood is not merely money, but it can be in health and peace of mind.'",
    "Translate into Arabic: 'Exhaust fumes can damage not only our health but also the environment.'",
    "Translate into Arabic: 'Magdi Yacoub, the legendary heart transplant surgeon, has been awarded many prizes locally and globally.'",
    "Translate into Arabic: 'Unity and cooperation are the necessary qualities which we need to succeed in our national projects.'",
    "Translate into Arabic: 'Young people must be armed with science and technology to achieve their ambitions.'",
    "Translate into Arabic: 'Inorganic farming can be a solution to overcome the problem of food shortage.'"
  ],

  arabicToEnglish: [
    "ترجم إلى الإنجليزية: قد تغير مفهوم التعليم من الحفظ والتلقين إلى التفكير الناقد والإبداع.",
    "ترجم إلى الإنجليزية: الإنترنت ومواقع التواصل الاجتماعي هما أسرع نظام اتصال متنامي في تاريخ البشرية.",
    "ترجم إلى الإنجليزية: يرتكب البعض خطأً كبيراً ببحثهم عن الشهرة لاعتقادهم بأنها سبب السعادة.",
    "ترجم إلى الإنجليزية: إنها مسؤولية الوالدين أن يقوموا بتنوير الشباب بالآثار المدمرة لتناول المخدرات القاتلة.",
    "ترجم إلى الإنجليزية: تسعى الحكومة بكل ما تملك من إمكانيات لتوفير الاحتياجات الرئيسية لجميع المواطنين.",
    "ترجم إلى الإنجليزية: اكتشف العلماء أن مناعة الإنسان تقل عندما يكون واقع تحت ضغط كبير.",
    "ترجم إلى الإنجليزية: تطورت الرياضة النسائية على مستوى الهواية والاحتراف دوليا فازدادت مشاركة النساء والفتيات في الرياضة هذه الأيام وقد حققن نجاحا كبيرا.",
    "ترجم إلى الإنجليزية: كان يحلم دائماً أن ينهي دراسته الجامعية ليجد وظيفة تعتمد عليها بعد التخرج. ولكن حبه للبحث العلمي ساعده كثيراً في الحصول على الدكتوراه والعمل في الجامعة.",
